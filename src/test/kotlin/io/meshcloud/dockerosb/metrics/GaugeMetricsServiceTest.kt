...
class GaugeMetricsServiceTest : BaseMetricsServiceTest() {
  ...
  private lateinit var gaugeController:PagedGaugeController

  @Before
  fun init() {
    gaugeController = PagedGaugeController(listOf(GaugeMetricProvider(catalogService.catalog.block() as Catalog, serviceInstanceRepository)))
  }
